    ...
    return p = i.prototype,
        ...
        p.randPosAndSpeed = function(e) {
            if (void 0 === e && (e = !1), e) {
                ...
                var o = Math.random();
                .25 >= o ? (this.x = 1 - this.r, this.y = Math.random() * Main.stage_height, this.v_x = Math.random(), this.v_y = Math.random() - .5) : o > .25 && .5 >= o ? (this.x = Main.stage_width + this.r - 1, this.y = Math.random() * Main.stage_height, this.v_x = -Math.random(), this.v_y = Math.random() - .5) : o > .5 && .75 >= o ? (this.x = Math.random() * Main.stage_height, this.y = 1 - this.r, this.v_x = Math.random() - .5, this.v_y = Math.random()) : (this.x = Math.random() * Main.stage_height, this.y = Main.stage_height + this.r - 1, this.v_x = Math.random() - .5, this.v_y = -Math.random())
            }
    ...
    Main = function(e) {
        ...
        return p = i.prototype,
            ...
            p.gameOver = function() {
                ...
                this.updateshare(i, this.getBeyondValue(i));
                //window.top.js.pause();
                //window.top.js.updateshare(i, this.getBeyondValue(i));
                document.getElementById("toolbar").style.display = "block";
            },
            p.updateshare = function(score, score1) {
                var sharetitle = '我在玩大球吞小球,你也来试试?';
                var mainjssharenumtitle = '我在大球吞小球吞掉{score}个小球,击败全国{score1}%的人!';
                if (score != 0) {
                    sharetitle = mainjssharenumtitle.replace('{score}', score).replace('{score1}', score1);
                }
                document.title = sharetitle;
            },
            p.shareTo = function() {
                //window.top.js.clickshare();
            ...
            p.createGameScene = function() {
                this.moveMSecByDist = 2500 / this.stage.stageWidth,
                    ...
                    t.config.ctrlBallX = 0.5 * t.stage_width,
                    t.config.ctrlBallY = 0.5 * t.stage_height,
                    this.game_timer = 0,
            ...
            p.infoTextDisplay = function() {
                this.eat_count = new egret.TextField,
                    this.eat_count.x = 0.05 * this.stage.stageWidth,
                    this.eat_count.y = 30,
                    this.eat_count.textColor = 111100,
            ...
            p.onTimeChange = function(e) {
                ...
                this.eat_count.text ="章鱼哥无敌版           "+ "           " + "个数: " + this.ctrlBall.getEatCount(),
                ...
                if (t.game_status < 4) {
                    ...
                    this.lastTime = e,
                       ...
                       // 2 == t.game_status && (t.game_status = 3, this.gameOver())
                        2 == t.game_status && (this.detectCollision(), this.updateDynamicBalls(i))
    
                }
                if (this.ctrlBall.getEatCount() > 200) {
                    var e = (new Date).getTime(),
                        i = e - this.lastTime;
                    this.lastTime = e,
                        1 == t.game_status && (this.detectCollision(), this.updateDynamicBalls(i)),
