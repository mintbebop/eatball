        ...
        return p = s.prototype, p.$init = function() {
            ...
            if (i)
                for (var r = null, s = 0; s < i.length; s++)
                    if (r = i[s], e ? r.name.toLowerCase() == t : r.name == t) return r;
            return null
            ...
            if (1 > o) return !1;
            for (; o >= 1;) {
                if (o--, i.$nextFrameNum++, i.$nextFrameNum > i.$totalFrames || i.$frameLabelStart > 0 && i.$nextFrameNum > i.$frameLabelEnd)
                    if (-1 == i.playTimes) i.$eventPool.push(t.Event.LOOP_COMPLETE), i.$nextFrameNum = 1;
                    else {
...
! function(t) {
    ...
    var i = function(e) {
        ...
        return p = r.prototype, i.get = function(t, e, r, s) {
        ...
        }, p.setPosition = function(t) {
            0 > t && (t = 0);
            var e = t,
                i = !1;
            if (e >= this.duration && (this.loop ? e %= this.duration : (e = this.duration, i = !0)), e == this._prevPos) return i;
            if (this.position = this._prevPos = e, this._prevPosition = t, this._target)
                if (i) this._updateTargetProps(null, 1);
                else if (this._steps.length > 0) {
                for (var r = 0, s = this._steps.length; s > r && !(this._steps[r].t > e); r++);
                var n = this._steps[r - 1];
                this._updateTargetProps(n, (this._stepPosition = e - n.t) / n.d)
            }
            return i && this.setPaused(!0), this.dispatchEventWith("change"), i
            ...
            var r, s, n, o, a;
            for (var h in e)
                if (t.sys.isUndefined(this._initQueueProps[h])) {
                    if (s = this._target[h], r = i._plugins[h])
                        for (n = 0, o = r.length; o > n; n++) s = r[n].init(this, h, s);
                    this._initQueueProps[h] = this._curQueueProps[h] = void 0 === s ? null : s
                } else s = this._curQueueProps[h];
            for (var h in e) {
                if (s = this._curQueueProps[h], r = i._plugins[h])
                    for (a = a || {}, n = 0, o = r.length; o > n; n++) r[n].step && r[n].step(this, h, s, e[h], a);
...
! function(t) {
    var e = function(e) {
        ...
        return p = s.prototype, r(p, "bounces", function() {
            ...
            for (var i = e.$target, r = this.$getPropagationList(i), s = r.length, n = .5 * r.length, o = -1, a = 0; s > a; a++)
                if (r[a] === this._content) {
                    o = a;
                    break
                }
            ...
            var r = Math.abs(t),
                ...
                h = e + 500 * t;
            if (0 > h || h > i)
                for (h = e; 1 / 0 != Math.abs(t) && Math.abs(t) > a;) h += t, t *= 0 > h || h > i ? o * s : o, n++;
        ...
        }, p.addChildAt = function() {
            return this.throwNotSupportedError(), null
        }, p.removeChild = function() {
            return this.throwNotSupportedError(), null
        }, p.removeChildAt = function() {
            return this.throwNotSupportedError(), null
        }, p.setChildIndex = function() {
            this.throwNotSupportedError()
        }, p.swapChildren = function() {
            this.throwNotSupportedError()
        }, p.swapChildrenAt = function() {
            this.throwNotSupportedError()
...
! function(t) {
    var e = function(e) {
        ...
        return p = s.prototype, i.$init = function() {
            ...
            for (var t = i._callBackList, e = t.length - 1; e >= 0; e--) t[e].$checkFrame();
            return !1
