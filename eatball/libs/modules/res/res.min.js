...
! function(e) {
    var t = function(t) {
        ...
        }, p.loadFile = function() {}, p.getRes = function() {}, p.destroyRes = function() {
            return !1
...
! function(e) {
    var t = function(t) {
        ...
        }, p.onResourceDestroy = function() {}, r
    }(e.AnalyzerBase);
        ...
        var r = function() {
            ...
            return p = t.prototype, p.fetchVersion = function(e) {
                ...
                var r = 0,
                    i = function(i) {
                        if (i)
                            for (var n = 0; n < i.length; n++) i[n] && "" != i[n] && t._localFileArr.push("resource/" + i[n]);
    ...
    var m = function(t) {
        ...
        return p = i.prototype, p.$getAnalyzerByType = function(e) {
            ...
            for (var t = this.loadedGroups, r = t.length, i = 0; r > i; i++)
                for (var n = this.resConfig.getRawGroupByName(t[i]), s = n.length, a = 0; s > a; a++) {
                    var o = n[a];
                    if (o.name == e) {
...
! function(e) {
    var t = function(t) {
        ...
        return p = i.prototype, p.onLoadFinish = function(e) {
            ...
            if (r)
                if (this.sheetMap[i] = r, r.file) n = this.getRelativePath(e.url, r.file);
                else {
                    var o = e.url.split("?"),
                        u = o[0].split("/");
            ...
            var r = e.lastIndexOf("/");
            return e = -1 != r ? e.substring(0, r + 1) + t : t
        }, p.parseAnimation = function(e, t) {
            for (var r, i = Object.keys(t.mc), n = t.mc[i[0]].frames, s = n.length, a = [], o = 0; s > o; o++) {
                r = t.res[n[o].res];
                var u = new egret.Texture;
                u._bitmapData = e, u.$initData(r.x, r.y, r.w, r.h, n[o].x, n[o].y, n[o].sourceW, n[o].sourceH, e.width, e.height)
            }
            return a
        }, p.destroyRes = function(e) {
            var t = this.fileDic[e];
